...
namespace SalaryCalculator
{
    public partial class SalaryCalculatorForm : Form
    {
        ...
        private decimal ComputeTaxThreshold(decimal baseThreshold, decimal hourlyRate, decimal overtime2xHours, decimal overtime3xHours, decimal insuranceDeduction)
        {
            ...
            // Công thức mới: mốc lương tính thuế + tiền bảo hiểm + 730000 + ((tiền OT x2 của số tiếng OT x2)/2) + ((tiền OT FWD)*1/12)
            decimal additionalOTx2 = ot2xSalary / 2m;
            decimal additionalOTFwd = otFwdSalary / 12m;

            return baseThreshold + insuranceDeduction + FixedThresholdAddon + additionalOTx2 + additionalOTFwd;
        }
