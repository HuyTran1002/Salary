...
namespace SalaryCalculator
{
    ...
    public class CalculatorForm : Form
    {
        ...
        {
            // Xử lý mũi tên và Enter trước tiên
        ...
        {
            System.Diagnostics.Debug.WriteLine($"ClickButtonByTag called with tag: {tag}");
                ...
                if (ctrl is TableLayoutPanel panel)
                {
                    foreach (Control panelCtrl in panel.Controls)
                    {
                        if (panelCtrl is Button btn)
                        {
                            ...
                            System.Diagnostics.Debug.WriteLine($"Found button with tag: {btnTag}");
                            if (btnTag == tag)
                            {
                                System.Diagnostics.Debug.WriteLine($"Clicking button with tag: {tag}");
                                btn.PerformClick();
                                return;
                            }
                        }
            ...
            System.Diagnostics.Debug.WriteLine($"No button found with tag: {tag}");
        }
