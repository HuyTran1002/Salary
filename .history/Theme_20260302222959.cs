    ...
    public static class Theme
    {
        ...
        public static void ApplyInfinityGlassTheme(Form form)
        {
            try
            {
                ...
                form.BackColor = Color.FromArgb(14, 16, 40);
                form.ForeColor = Color.FromArgb(238, 243, 255);
        ...
        private static void ApplyInfinityGlassToControls(Control.ControlCollection controls)
        {
            foreach (Control ctrl in controls)
            {
                ...
                {
                    panel.BackColor = Color.FromArgb(34, 34, 74);
                    panel.Padding = new Padding(Math.Max(panel.Padding.Left, 10), Math.Max(panel.Padding.Top, 10), Math.Max(panel.Padding.Right, 10), Math.Max(panel.Padding.Bottom, 10));
                    panel.BorderStyle = BorderStyle.None;
                    EnableDoubleBuffer(panel);
                }
                else if (ctrl is GroupBox gb)
                {
                    gb.BackColor = Color.FromArgb(40, 40, 84);
                    gb.ForeColor = Color.FromArgb(236, 244, 255);
                    gb.Font = new Font("Segoe UI", gb.Font.Size, FontStyle.Bold);
                }
                else if (ctrl is Button btn)
                {
                    ...
                    btn.FlatAppearance.BorderColor = Color.FromArgb(124, 164, 255);
                    btn.ForeColor = Color.White;
                    btn.Font = new Font("Segoe UI", Math.Max(9, btn.Font.Size), FontStyle.Bold);
                    btn.Cursor = Cursors.Hand;

                    Color baseColor = Color.FromArgb(57, 122, 255);
                    Color hoverColor = Color.FromArgb(88, 147, 255);

                    if (btn.Text.IndexOf("ĐĂNG XUẤT", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        btn.Text.IndexOf("HỦY", StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        baseColor = Color.FromArgb(88, 63, 130);
                        hoverColor = Color.FromArgb(107, 80, 149);
                    }
                    ...
                    {
                        baseColor = Color.FromArgb(0, 198, 255);
                        hoverColor = Color.FromArgb(54, 219, 255);
                    }
                    else if (btn.Text.Contains("✏️"))
                    {
                        baseColor = Color.FromArgb(84, 92, 204);
                        hoverColor = Color.FromArgb(108, 118, 225);
                    }
                ...
                else if (ctrl is Label label)
                {
                    ...
                    label.ForeColor = isTitle ? Color.FromArgb(242, 246, 255) : Color.FromArgb(190, 201, 240);
                    if (!string.IsNullOrWhiteSpace(label.Text) && label.Text.Contains("━━━━━━━━"))
                    {
                        label.ForeColor = Color.FromArgb(110, 122, 188);
                    }
                }
                else if (ctrl is TextBox tb)
                {
                    tb.BorderStyle = BorderStyle.FixedSingle;
                    tb.ForeColor = Color.FromArgb(238, 244, 255);
                    tb.BackColor = tb.ReadOnly
                        ? Color.FromArgb(52, 54, 102)
                        : Color.FromArgb(38, 42, 90);
                }
                else if (ctrl is CheckBox cb)
                {
                    cb.ForeColor = Color.FromArgb(224, 238, 255);
                    cb.BackColor = Color.FromArgb(34, 34, 74);
                }
                else if (ctrl is ComboBox combo)
                {
                    combo.BackColor = Color.FromArgb(38, 42, 90);
                    combo.ForeColor = Color.FromArgb(238, 244, 255);
                    combo.FlatStyle = FlatStyle.Flat;
                }
        ...
        private static void StyleInfinityGlassDataGridView(DataGridView dgv)
        {
            ...
            dgv.BackgroundColor = Color.FromArgb(28, 30, 70);
            dgv.GridColor = Color.FromArgb(82, 100, 178);
            dgv.CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
            dgv.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(68, 118, 255);
            ...
            dgv.DefaultCellStyle.BackColor = Color.FromArgb(38, 42, 90);
            dgv.DefaultCellStyle.ForeColor = Color.FromArgb(238, 244, 255);
            dgv.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(46, 50, 101);
            dgv.DefaultCellStyle.SelectionBackColor = Color.FromArgb(124, 76, 255);
            dgv.DefaultCellStyle.SelectionForeColor = Color.FromArgb(255, 255, 255);
        }
            ...
            try
            {
                ...
                using (var g = Graphics.FromImage(background))
                {
                    ...
                    using (var baseGradient = new System.Drawing.Drawing2D.LinearGradientBrush(
                        ...
                        Color.FromArgb(12, 14, 36),
                        Color.FromArgb(20, 28, 72),
                        130f))
                    {
                    ...
                    using (var sweep = new System.Drawing.Drawing2D.LinearGradientBrush(
                        new Rectangle(0, 0, width, height),
                        Color.FromArgb(98, 132, 78, 255),
                        Color.FromArgb(18, 40, 24, 66),
                        35f))
                    {
                    ...
                    using (var orb1 = new SolidBrush(Color.FromArgb(130, 0, 214, 255)))
                    {
                        g.FillEllipse(orb1, -width / 6 + driftA, height / 9, width * 3 / 5, height * 3 / 5);
                    }

                    using (var orb2 = new SolidBrush(Color.FromArgb(118, 146, 92, 255)))
                    {
                        g.FillEllipse(orb2, width / 2 + driftB, -height / 4, width * 3 / 5, height * 3 / 5);
                    }

                    using (var orb3 = new SolidBrush(Color.FromArgb(105, 249, 86, 198)))
                    {
                        g.FillEllipse(orb3, width / 4 + driftC, height / 2, width * 2 / 3, height / 2);
                    }

                    using (var streakPen = new Pen(Color.FromArgb(68, 164, 215, 255), 2f))
                    {
                    ...
                    for (int i = 0; i < 18; i++)
                    {
                        ...
                        using (var sparkle = new SolidBrush(Color.FromArgb(alpha, 220, 245, 255)))
                        {
