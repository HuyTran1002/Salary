    ...
    public static class Theme
    {
        ...
        public static void ApplyInfinityGlassTheme(Form form)
        {
            try
            {
                ...
                form.BackColor = Color.FromArgb(10, 10, 10);
                form.ForeColor = Color.FromArgb(235, 235, 235);
        ...
        private static void ApplyInfinityGlassToControls(Control.ControlCollection controls)
        {
            foreach (Control ctrl in controls)
            {
                ...
                {
                    gb.BackColor = Color.FromArgb(26, 26, 26);
                    gb.ForeColor = Color.FromArgb(242, 242, 242);
                    gb.Font = new Font("Segoe UI", gb.Font.Size, FontStyle.Bold);
                }
                else if (ctrl is Button btn)
                {
                    ...
                    Color baseColor = Color.FromArgb(229, 9, 20);
                    Color hoverColor = Color.FromArgb(198, 7, 18);

                    if (btn.Text.IndexOf("ĐĂNG XUẤT", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        btn.Text.IndexOf("HỦY", StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        baseColor = Color.FromArgb(58, 58, 58);
                        hoverColor = Color.FromArgb(78, 78, 78);
                    }
                    ...
                    {
                        baseColor = Color.FromArgb(229, 9, 20);
                        hoverColor = Color.FromArgb(198, 7, 18);
                    }
                    else if (btn.Text.Contains("✏️"))
                    {
                        baseColor = Color.FromArgb(44, 44, 44);
                ...
                else if (ctrl is Label label)
                {
                    ...
                    label.ForeColor = isTitle ? Color.FromArgb(245, 245, 245) : Color.FromArgb(195, 195, 195);
                ...
                {
                    tb.BorderStyle = BorderStyle.FixedSingle;
                    tb.ForeColor = Color.FromArgb(238, 238, 238);
                ...
                {
                    cb.ForeColor = Color.FromArgb(225, 225, 225);
                    cb.BackColor = Color.FromArgb(24, 24, 24);
                }
                else if (ctrl is ComboBox combo)
                {
                    combo.BackColor = Color.FromArgb(28, 28, 28);
        ...
        private static void StyleInfinityGlassDataGridView(DataGridView dgv)
        {
            ...
            dgv.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(229, 9, 20);
            ...
            dgv.DefaultCellStyle.BackColor = Color.FromArgb(22, 22, 22);
            dgv.DefaultCellStyle.ForeColor = Color.FromArgb(234, 234, 234);
            dgv.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(28, 28, 28);
            dgv.DefaultCellStyle.SelectionBackColor = Color.FromArgb(90, 20, 25);
            dgv.DefaultCellStyle.SelectionForeColor = Color.FromArgb(245, 245, 245);
        }
        ...
        private static void ApplyInfinityBackdrop(Form form, int phase)
        {
            try
            {
                ...
                using (var g = Graphics.FromImage(background))
                {
                    ...
                    using (var orb1 = new SolidBrush(Color.FromArgb(120, 160, 10, 20)))
                    {
                        g.FillEllipse(orb1, -width / 6 + driftA, height / 9, width * 3 / 5, height * 3 / 5);
                    }

                    using (var orb2 = new SolidBrush(Color.FromArgb(105, 120, 12, 35)))
                    {
                        g.FillEllipse(orb2, width / 2 + driftB, -height / 4, width * 3 / 5, height * 3 / 5);
                    }

                    using (var orb3 = new SolidBrush(Color.FromArgb(90, 229, 9, 20)))
                    {
