                          ...
                          TextBox allowanceTextBox, TextBox recognizeTextBox, TextBox otherBonusTextBox, TextBox taxThresholdTextBox)
        {
            try
            {
                ...
                string detail = $"Chi Tiết:\n" +
                    ...
                    $"  • OT FWD ({otFwdHours:F1} tiếng × {hourlyRate:C0} × 2): {otFwdSalary:C0} VND\n" +
                    $"  • OT x2 ({ot2xHours:F1} tiếng × {hourlyRate:C0} × 2): {ot2xSalary:C0} VND\n" +
                ...
                overtime2xResultLabel.Text = $"{otFwdHours:F1}H OT FWD: {otFwdSalary:C0} | {ot2xHours:F1}H OT x2: {ot2xSalary:C0}";
