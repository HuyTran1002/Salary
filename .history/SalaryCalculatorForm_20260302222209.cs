...
namespace SalaryCalculator
{
    public partial class SalaryCalculatorForm : Form
    {
            ...
            private Color[] marqueeColors = new Color[] 
            {
                ...
                Color.FromArgb(40, 12, 14),
                Color.FromArgb(55, 14, 18),
                Color.FromArgb(72, 16, 22),
                Color.FromArgb(46, 18, 20)
            };
        ...
        private void InitializeComponent()
        {
            if (currentUsername == "admin")
            {
                ...
                rankingGrid.GridColor = Color.FromArgb(45, 45, 45);
                rankingGrid.BackgroundColor = Color.FromArgb(18, 18, 18);
                ...
                rankingGrid.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(229, 9, 20);
                ...
                rankingGrid.RowsDefaultCellStyle.BackColor = Color.FromArgb(22, 22, 22);
                rankingGrid.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(28, 28, 28);
                rankingGrid.DefaultCellStyle.SelectionBackColor = Color.FromArgb(90, 20, 25);
                rankingGrid.DefaultCellStyle.SelectionForeColor = Color.FromArgb(245, 245, 245);
                rankingGrid.DefaultCellStyle.ForeColor = Color.FromArgb(234, 234, 234);
                ...
                foreach (var u in sortedBySalary)
                {
                    ...
                    if (rank == 1)
                    {
                        ...
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(72, 16, 22);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(255, 240, 240);
                    }
                    else if (rank == 2)
                    {
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.Font = new System.Drawing.Font("Arial", 11, System.Drawing.FontStyle.Bold);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(58, 20, 24);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(248, 238, 238);
                    }
                    else if (rank == 3)
                    {
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.Font = new System.Drawing.Font("Arial", 10.5f, System.Drawing.FontStyle.Bold);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(46, 20, 22);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(242, 236, 236);
                    }
                    else
                    {
                        ...
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(22, 22, 22);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(234, 234, 234);
                    }
                    rank++;
                }
                ...
                for (int i = sorted.Count + 1; i <= minRows; i++)
                {
                    ...
                    rankingGrid.Rows[idx].DefaultCellStyle.BackColor = Color.FromArgb(20, 20, 20);
                }
                ...
                try
                {
                    ...
                    rankingGrid.RowsDefaultCellStyle.BackColor = Color.FromArgb(22, 22, 22);
                    rankingGrid.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(28, 28, 28);
                    rankingGrid.DefaultCellStyle.BackColor = Color.FromArgb(22, 22, 22);
                    rankingGrid.DefaultCellStyle.ForeColor = Color.FromArgb(234, 234, 234);
                    rankingGrid.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(229, 9, 20);
                    rankingGrid.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
                    rankingGrid.EnableHeadersVisualStyles = false;
            ...
            marqueeLabel.BackColor = Color.FromArgb(35, 12, 14);
        ...
        private void ApplyReadonlyTextboxStyles()
        {
            ...
            foreach (var name in readonlyNames)
            {
                ...
                {
                    tb.ReadOnly = true;
                    tb.BackColor = System.Drawing.Color.FromArgb(36, 36, 36);
                    tb.ForeColor = System.Drawing.Color.FromArgb(238, 238, 238);
                }
            }
        }
