...
namespace SalaryCalculator
{
    public partial class SalaryCalculatorForm : Form
    {
            ...
            {
                Color.FromArgb(205, 229, 250),
                Color.FromArgb(192, 223, 248),
                Color.FromArgb(178, 216, 246),
                Color.FromArgb(165, 209, 244),
                Color.FromArgb(176, 220, 252),
                Color.FromArgb(188, 214, 248),
                Color.FromArgb(198, 222, 255)
            };
