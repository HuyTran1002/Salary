        ...
        private static void ApplyInfinityBackdrop(Form form, int phase)
        {
            try
            {
                ...
                using (var g = Graphics.FromImage(background))
                {
                    ...
                    int driftA = (int)(Math.Sin(phase * Math.PI / 180.0) * 22);
                    int driftB = (int)(Math.Cos((phase + 60) * Math.PI / 180.0) * 24);
                    int driftC = (int)(Math.Sin((phase + 130) * Math.PI / 180.0) * 18);
                    ...
                    int cloudFloat = (int)(Math.Sin((phase + 40) * Math.PI / 180.0) * 8);
                    DrawCloud(g, width / 10 + driftA / 2, height / 8 + cloudFloat, width / 5, height / 10, Color.FromArgb(150, 255, 255, 255));
                    DrawCloud(g, width / 2 + driftB / 2, height / 6 - cloudFloat / 2, width / 4, height / 9, Color.FromArgb(140, 255, 255, 255));
                    DrawCloud(g, width - width / 3 + driftC / 2, height / 4 + cloudFloat / 2, width / 5, height / 10, Color.FromArgb(130, 255, 255, 255));
                    ...
                    for (int i = 0; i < 20; i++)
                    {
                        ...
                        int alpha = 60 + (int)(80 * Math.Abs(Math.Sin((phase + i * 9) * Math.PI / 180.0)));

                        if (i % 3 == 0)
                        {
                            DrawTwinkle(g, sx, sy, 4 + (i % 3), Color.FromArgb(alpha, 255, 255, 255));
                        }
                        else
                        {
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        int hx = (int)((i * 173 + phase * 2 + 80) % Math.Max(width - 20, 1)) + 10;
                        int hy = (int)((i * 131 + phase + 60) % Math.Max(height - 40, 1)) + 20;
                        int heartSize = 8 + (i % 4);
                        int alpha = 38 + (int)(22 * Math.Abs(Math.Sin((phase + i * 24) * Math.PI / 180.0)));
                        DrawCuteHeart(g, hx, hy, heartSize, Color.FromArgb(alpha, 255, 140, 196));
                    }
                    ...
                    for (int i = 0; i < 14; i++)
                    {
                        ...
                        using (var bubble = new SolidBrush(Color.FromArgb(22 + i % 4 * 8, 255, 255, 255)))
                        {
