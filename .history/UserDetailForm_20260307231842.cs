...
namespace SalaryCalculator
{
    public class UserDetailForm : Form
    {
        ...
        public UserDetailForm(UserInfo user)
        {
            ...
            infoColumns.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 58));
            infoColumns.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 42));
            ...
            var leftInfoTable = CreateInfoSideTable(58f);
            var rightInfoTable = CreateInfoSideTable(46f);
