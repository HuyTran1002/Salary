                          ...
                          TextBox allowanceTextBox, TextBox recognizeTextBox, TextBox otherBonusTextBox, TextBox taxThresholdTextBox)
        {
            try
            {
                ...
                string incentiveInfo = $"\n  • Tổng phụ cấp: {allowanceTotal:C0} VND" +
                                        $"\n    - Tiền đi lại thực tế (({adjustedTravelPerMonth:C0} / {workingDays:F1} ngày công) × {allowanceEligibleDays:F1} ngày đi làm): {travelAllowance:C0} VND" +
                                        $"\n    - Tiền chuyên cần thực tế (({adjustedAttendancePerMonth:C0} / {workingDays:F1} ngày công) × {allowanceEligibleDays:F1} ngày đi làm): {attendanceIncentive:C0} VND" +
