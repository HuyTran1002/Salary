    ...
    public static class Theme
    {
        ...
        public static void ApplyInfinityGlassTheme(Form form)
        {
            try
            {
                ...
                form.BackColor = Color.FromArgb(10, 20, 38);
                form.ForeColor = Color.FromArgb(230, 241, 255);
        ...
        private static void ApplyInfinityGlassToControls(Control.ControlCollection controls)
        {
            foreach (Control ctrl in controls)
            {
                ...
                {
                    panel.BackColor = Color.FromArgb(30, 45, 72);
                ...
                {
                    gb.BackColor = Color.FromArgb(34, 52, 82);
                    gb.ForeColor = Color.FromArgb(232, 244, 255);
                    gb.Font = new Font("Segoe UI", gb.Font.Size, FontStyle.Bold);
                }
                else if (ctrl is Button btn)
                {
                    ...
                    btn.FlatAppearance.BorderColor = Color.FromArgb(90, 146, 217);
                    btn.ForeColor = Color.White;
                    btn.Font = new Font("Segoe UI", Math.Max(9, btn.Font.Size), FontStyle.Bold);

                    Color baseColor = Color.FromArgb(0, 113, 197);
                    Color hoverColor = Color.FromArgb(0, 139, 226);

                    if (btn.Text.IndexOf("ĐĂNG XUẤT", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        btn.Text.IndexOf("HỦY", StringComparison.OrdinalIgnoreCase) >= 0)
                    {
                        baseColor = Color.FromArgb(57, 74, 104);
                        hoverColor = Color.FromArgb(72, 92, 126);
                    }
                    ...
                    {
                        baseColor = Color.FromArgb(0, 132, 235);
                        hoverColor = Color.FromArgb(22, 158, 255);
                    }
                    else if (btn.Text.Contains("✏️"))
                    {
                        baseColor = Color.FromArgb(36, 87, 134);
                        hoverColor = Color.FromArgb(54, 108, 160);
                    }
                ...
                else if (ctrl is Label label)
                {
                    ...
                    label.ForeColor = isTitle ? Color.FromArgb(234, 246, 255) : Color.FromArgb(178, 204, 232);
                    if (!string.IsNullOrWhiteSpace(label.Text) && label.Text.Contains("━━━━━━━━"))
                    {
                        label.ForeColor = Color.FromArgb(94, 125, 168);
                    }
                }
                else if (ctrl is TextBox tb)
                {
                    ...
                    tb.BackColor = tb.ReadOnly
                        ? Color.FromArgb(43, 61, 92)
                        : Color.FromArgb(28, 48, 78);
                }
                else if (ctrl is CheckBox cb)
                {
                    cb.ForeColor = Color.FromArgb(218, 236, 255);
                    cb.BackColor = Color.FromArgb(30, 45, 72);
                }
                else if (ctrl is ComboBox combo)
                {
                    combo.BackColor = Color.FromArgb(28, 48, 78);
                    combo.ForeColor = Color.FromArgb(232, 244, 255);
                    combo.FlatStyle = FlatStyle.Flat;
                }
        ...
        private static void StyleInfinityGlassDataGridView(DataGridView dgv)
        {
            ...
            dgv.BackgroundColor = Color.FromArgb(21, 37, 60);
            dgv.GridColor = Color.FromArgb(64, 98, 145);
            dgv.CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
            dgv.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(0, 113, 197);
            ...
            dgv.DefaultCellStyle.BackColor = Color.FromArgb(28, 48, 78);
            dgv.DefaultCellStyle.ForeColor = Color.FromArgb(232, 244, 255);
            dgv.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(34, 56, 90);
            dgv.DefaultCellStyle.SelectionBackColor = Color.FromArgb(0, 150, 255);
            ...
            try
            {
                ...
                using (var g = Graphics.FromImage(background))
                {
                    ...
                    using (var sweep = new System.Drawing.Drawing2D.LinearGradientBrush(
                        new Rectangle(0, 0, width, height),
                        Color.FromArgb(95, 35, 158, 255),
                        Color.FromArgb(18, 10, 28, 52),
                        35f))
                    {
                    ...
                    using (var orb1 = new SolidBrush(Color.FromArgb(118, 0, 132, 235)))
                    {
                        g.FillEllipse(orb1, -width / 6 + driftA, height / 9, width * 3 / 5, height * 3 / 5);
                    }

                    using (var orb2 = new SolidBrush(Color.FromArgb(98, 70, 178, 255)))
                    {
                        g.FillEllipse(orb2, width / 2 + driftB, -height / 4, width * 3 / 5, height * 3 / 5);
                    }

                    using (var orb3 = new SolidBrush(Color.FromArgb(94, 0, 202, 255)))
                    {
                        g.FillEllipse(orb3, width / 4 + driftC, height / 2, width * 2 / 3, height / 2);
                    }

                    using (var streakPen = new Pen(Color.FromArgb(42, 160, 220, 255), 2f))
                    {
