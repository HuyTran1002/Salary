...
namespace SalaryCalculator
{
    ...
    public class CalculatorForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // ===== PANEL CHO 4 NÚT MŨI TÊN (D-PAD) - DỊ CHUYỂN SANG PHẢI 50PX =====
            var navPanel = new TableLayoutPanel();
            navPanel.ColumnCount = 3;
            navPanel.RowCount = 3;
            navPanel.Width = 120;
            navPanel.Height = 120;
            navPanel.Location = new Point(60, 110);  // Dịch sang phải 50px
            ...
            // ===== PANEL CHO PHÍM SỐ VÀ PHÉP TÍNH - VỀ VỊ TRÍ CŨ =====
            var mainTable = new TableLayoutPanel();
            mainTable.ColumnCount = 4;
            mainTable.RowCount = 6;  // 6 hàng cho phím số (từ AC-DEL-() đến hàng Ans-^-=)
            mainTable.Width = 400;
            mainTable.Height = 440;
            mainTable.Location = new Point(10, 240);  // Phía dưới panel mũi tên
