...
namespace SalaryCalculator
{
    public class UserDetailForm : Form
    {
        ...
        public UserDetailForm(UserInfo user)
        {
            ...
            infoColumns.Padding = new Padding(8, 6, 8, 6);
            ...
            TableLayoutPanel CreateInfoSideTable()
            {
                ...
                sideTable.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 48));
                sideTable.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 52));
            ...
            var leftInfoTable = CreateInfoSideTable();
            var rightInfoTable = CreateInfoSideTable();
            ...
            // Left side holds longer labels to avoid truncation.
            ...
            AddInfoRow(leftInfoTable, 4, "Tiền chuyên cần/tháng:", attendancePerMonth.ToString("N0") + " VND");

            AddInfoRow(rightInfoTable, 0, "Số điện thoại:", user.Phone);
            AddInfoRow(rightInfoTable, 1, "Tuổi:", user.Age.ToString());
            AddInfoRow(rightInfoTable, 2, "Tiền đi lại/tháng:", travelPerMonth.ToString("N0") + " VND");
            AddInfoRow(rightInfoTable, 3, "Tiền nhà ở:", user.HousingAllowance.ToString("N0") + " VND");
            AddInfoRow(rightInfoTable, 4, "Thưởng cert:", user.CertificateBonus.ToString("N0") + " VND");
