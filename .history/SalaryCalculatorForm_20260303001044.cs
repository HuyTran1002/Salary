...
namespace SalaryCalculator
{
    public partial class SalaryCalculatorForm : Form
    {
        ...
        private void StickFigureHostPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            PointF leftFootTarget = new PointF(hipLeft.X - 4.4f + direction * stride * 1.8f, stickFigurePosition.Y + 11f + stride * 1.2f);
            PointF rightFootTarget = new PointF(hipRight.X + 4.4f - direction * stride * 1.8f, stickFigurePosition.Y + 11f - stride * 1.2f);
            ...
            if (stickAction == "Chạy")
            {
                ...
                leftFootTarget = new PointF(hipLeft.X - 4f + direction * sprint * 0.95f, stickFigurePosition.Y + 11f + sprint);
                rightFootTarget = new PointF(hipRight.X + 4f - direction * sprint * 0.95f, stickFigurePosition.Y + 11f - sprint);
            }
            ...
            PointF leftElbow = ComputeJointPoint(shoulderLeft, leftHandTarget, 8.8f, 8.3f, false);
            PointF rightElbow = ComputeJointPoint(shoulderRight, rightHandTarget, 8.8f, 8.3f, true);
            PointF leftKnee = ComputeJointPoint(hipLeft, leftFootTarget, 9.2f, 10.2f, false);
            PointF rightKnee = ComputeJointPoint(hipRight, rightFootTarget, 9.2f, 10.2f, true);
