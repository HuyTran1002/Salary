...
namespace SalaryCalculator
{
    public partial class LoginForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Phone/Zalo (hidden by default) - now WWID
        ...
        private void HandleLogin(string username, string fullName, string wwid, string age, string salary, string meal, string cert, string attendancePerDay, string travelPerDay, string housingAllowance)
        {
            ...
            if (isRegistering)
            {
                ...
                // Validate WWID: must not be empty, at least 8 characters, max 20
                ...
                if (wwid.Length < 8)
                {
                    MessageBox.Show("WWID phải có ít nhất 8 ký tự!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                if (wwid.Length > 20)
                {
                    MessageBox.Show("WWID không được quá 20 ký tự!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
