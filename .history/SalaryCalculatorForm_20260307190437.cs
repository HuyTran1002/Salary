                          ...
                          TextBox allowanceTextBox, TextBox recognizeTextBox, TextBox otherBonusTextBox, TextBox taxThresholdTextBox)
        {
            try
            {
                ...
                string incentiveInfo = $"\n  • Tổng phụ cấp: {allowanceTotal:C0} VND" +
                                        $"\n    - Tiền đi lại ({travelPerDayEffective:C0} × {allowanceEligibleDays:F1}): {travelAllowance:C0} VND" +
                                        $"\n    - Tiền chuyên cần ({attendancePerDayEffective:C0} × {allowanceEligibleDays:F1}): {attendanceIncentive:C0} VND" +
