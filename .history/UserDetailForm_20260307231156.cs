...
namespace SalaryCalculator
{
    public class UserDetailForm : Form
    {
        ...
        public UserDetailForm(UserInfo user)
        {
            ...
            infoTable.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 26));
            infoTable.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 24));
            infoTable.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 26));
            infoTable.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 24));
            ...
            AddInfoPairRow(2, "Lương cơ bản:", user.BasicSalary.ToString("N0") + " VND", "Tiền ăn/tháng:", user.MealAllowance.ToString("N0") + " VND");
