    ...
    public class UserDetailForm : Form
    {
        ...
        public UserDetailForm(UserInfo user)
        {
            ...
            for (int i = 0; i < salaryRows; i++)
                salaryTable.RowStyles.Add(new RowStyle(SizeType.Absolute, 28));
            ...
            if (user.SalaryHistory != null && user.SalaryHistory.Count > 0)
            {
                                            ...
                                            }))
                {
                    ...
                    salaryTable.Controls.Add(new Label { Text = entry.Key, Dock = DockStyle.Fill, TextAlign = System.Drawing.ContentAlignment.MiddleRight, Font = new System.Drawing.Font("Segoe UI", 9.5f), AutoSize = false, Padding = new Padding(0, 3, 0, 0) }, 0, row);
                    salaryTable.Controls.Add(new Label { Text = entry.Value.ToString("N0") + " VND", Dock = DockStyle.Fill, TextAlign = System.Drawing.ContentAlignment.MiddleLeft, Font = new System.Drawing.Font("Segoe UI", 9.5f, System.Drawing.FontStyle.Bold), ForeColor = System.Drawing.Color.DarkGreen, AutoSize = false, Padding = new Padding(0, 3, 0, 0) }, 1, row);
                    row++;
                }
                // Nếu ít hơn 6 tháng thì thêm dòng trống
                for (; row < salaryRows; row++)
                {
                    salaryTable.Controls.Add(new Label { Text = "", Dock = DockStyle.Fill, TextAlign = System.Drawing.ContentAlignment.MiddleRight, Font = new System.Drawing.Font("Segoe UI", 9.5f), AutoSize = false }, 0, row);
                    salaryTable.Controls.Add(new Label { Text = "", Dock = DockStyle.Fill, TextAlign = System.Drawing.ContentAlignment.MiddleLeft, Font = new System.Drawing.Font("Segoe UI", 9.5f), AutoSize = false }, 1, row);
                }
            }
            else
            {
                salaryTable.Controls.Add(new Label { Text = "Không có dữ liệu", Dock = DockStyle.Fill, TextAlign = System.Drawing.ContentAlignment.MiddleLeft, Font = new System.Drawing.Font("Segoe UI", 9.5f, System.Drawing.FontStyle.Italic), ForeColor = System.Drawing.Color.Gray, AutoSize = false, Padding = new Padding(0, 3, 0, 0) }, 0, 0);
                for (int i = 1; i < salaryRows; i++)
                {
                    salaryTable.Controls.Add(new Label { Text = "", Dock = DockStyle.Fill, TextAlign = System.Drawing.ContentAlignment.MiddleRight, Font = new System.Drawing.Font("Segoe UI", 9.5f), AutoSize = false }, 0, i);
                    salaryTable.Controls.Add(new Label { Text = "", Dock = DockStyle.Fill, TextAlign = System.Drawing.ContentAlignment.MiddleLeft, Font = new System.Drawing.Font("Segoe UI", 9.5f), AutoSize = false }, 1, i);
                }
            }
