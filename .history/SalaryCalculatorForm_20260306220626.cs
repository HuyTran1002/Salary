    ...
    public partial class SalaryCalculatorForm : Form
    {
                          ...
                          TextBox allowanceTextBox, TextBox recognizeTextBox, TextBox otherBonusTextBox, TextBox taxThresholdTextBox)
        {
            try
            {
                ...
                int month = int.Parse(monthTextBox.Text);
                int year = int.Parse(yearTextBox.Text);
                var calculationDetail = new SalaryCalculationDetail
                {
                    Month = month,
                    Year = year,
                ...
                if (!string.IsNullOrEmpty(overtime2xTextBox.Text)) calculationDetail.Overtime2xHours = overtime2xHours;
                if (!string.IsNullOrEmpty(overtime3xTextBox.Text)) calculationDetail.Overtime3xHours = overtime3xHours;
                if (!string.IsNullOrEmpty(otDays12TextBox.Text)) calculationDetail.OtDays12 = otDays12;
                if (!string.IsNullOrEmpty(otDays8TextBox.Text)) calculationDetail.OtDays8 = otDays8;
                if (!string.IsNullOrEmpty(overtime15xTextBox.Text)) calculationDetail.Overtime15xHours = overtime15xHours;
                if (!string.IsNullOrEmpty(selectedRating)) calculationDetail.SelectedRating = selectedRating;
                if (!string.IsNullOrEmpty(recognizeTextBox.Text)) calculationDetail.RecognizeCount = recognizeCount;
                if (!string.IsNullOrEmpty(otherBonusTextBox.Text)) calculationDetail.OtherBonus = otherBonus;
                if (!string.IsNullOrEmpty(meal12Amount.ToString()) && meal12Amount != 0) calculationDetail.Meal12Amount = meal12Amount; // assuming meal12Amount is set
                if (!string.IsNullOrEmpty(meal8Amount.ToString()) && meal8Amount != 0) calculationDetail.Meal8Amount = meal8Amount;
                if (!string.IsNullOrEmpty(travelPerDay.ToString()) && travelPerDay != 0) calculationDetail.TravelPerDay = travelPerDay;
                if (!string.IsNullOrEmpty(attendancePerDay.ToString()) && attendancePerDay != 0) calculationDetail.AttendancePerDay = attendancePerDay;
                if (!string.IsNullOrEmpty(certificateBonus.ToString()) && certificateBonus != 0) calculationDetail.CertificateBonus = certificateBonus;
                if (!string.IsNullOrEmpty(rankingAAmount.ToString()) && rankingAAmount != 0) calculationDetail.RankingABonusAmount = rankingAAmount;
                if (!string.IsNullOrEmpty(rankingBAmount.ToString()) && rankingBAmount != 0) calculationDetail.RankingBBonusAmount = rankingBAmount;
                if (!string.IsNullOrEmpty(rankingCAmount.ToString()) && rankingCAmount != 0) calculationDetail.RankingCBonusAmount = rankingCAmount;
                userDataManager.UpdateLastCalculation(currentUsername, month, year, netSalary, calculationDetail);
