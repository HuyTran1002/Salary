...
namespace SalaryCalculator
{
    ...
    public class CalculatorForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            AddBtn("Ans", 3, 1, tag: "Ans", bgColor: opColor);
            ...
            // Row 7: 0 (không span, bằng phím số khác), ., +, %
            AddBtn("0", 0, 7);
            AddBtn(".", 1, 7, tag: ".");
            AddBtn("+", 2, 7, tag: "+", bgColor: opColor);
            AddBtn("%", 3, 7, tag: "%", bgColor: opColor);

            // Row 8: ^, = (dài nhất - spanning 3 cols)
            AddBtn("^", 0, 8, tag: "^", bgColor: opColor);
            AddBtn("=", 1, 8, colSpan: 3, tag: "=", bgColor: eqColor);
