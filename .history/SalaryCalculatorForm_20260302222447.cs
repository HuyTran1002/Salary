...
namespace SalaryCalculator
{
    public partial class SalaryCalculatorForm : Form
    {
            ...
            {
                Color.FromArgb(26, 44, 70),
                Color.FromArgb(34, 58, 92),
                Color.FromArgb(22, 74, 118),
                Color.FromArgb(36, 82, 126),
                Color.FromArgb(28, 52, 84)
            };
        ...
        private void InitializeComponent()
        {
            if (currentUsername == "admin")
            {
                ...
                rankingGrid.GridColor = Color.FromArgb(64, 98, 145);
                rankingGrid.BackgroundColor = Color.FromArgb(21, 37, 60);
                ...
                rankingGrid.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(0, 113, 197);
                ...
                rankingGrid.RowsDefaultCellStyle.BackColor = Color.FromArgb(28, 48, 78);
                rankingGrid.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(34, 56, 90);
                rankingGrid.DefaultCellStyle.SelectionBackColor = Color.FromArgb(0, 150, 255);
                rankingGrid.DefaultCellStyle.SelectionForeColor = Color.White;
                rankingGrid.DefaultCellStyle.ForeColor = Color.FromArgb(232, 244, 255);
                ...
                foreach (var u in sortedBySalary)
                {
                    ...
                    if (rank == 1)
                    {
                        ...
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(22, 74, 118);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(238, 250, 255);
                    }
                    else if (rank == 2)
                    {
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.Font = new System.Drawing.Font("Arial", 11, System.Drawing.FontStyle.Bold);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(32, 68, 108);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(236, 246, 255);
                    }
                    else if (rank == 3)
                    {
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.Font = new System.Drawing.Font("Arial", 10.5f, System.Drawing.FontStyle.Bold);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(36, 62, 98);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(234, 244, 255);
                    }
                    else
                    {
                        ...
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(28, 48, 78);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(232, 244, 255);
                    }
                    rank++;
                }
                ...
                for (int i = sorted.Count + 1; i <= minRows; i++)
                {
                    ...
                    rankingGrid.Rows[idx].DefaultCellStyle.BackColor = Color.FromArgb(26, 44, 70);
                }
                ...
                try
                {
                    ...
                    rankingGrid.RowsDefaultCellStyle.BackColor = Color.FromArgb(28, 48, 78);
                    rankingGrid.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(34, 56, 90);
                    rankingGrid.DefaultCellStyle.BackColor = Color.FromArgb(28, 48, 78);
                    rankingGrid.DefaultCellStyle.ForeColor = Color.FromArgb(232, 244, 255);
                    rankingGrid.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(0, 113, 197);
                    rankingGrid.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
                    rankingGrid.EnableHeadersVisualStyles = false;
            ...
            calculatorLauncher.BackColor = Color.FromArgb(0, 113, 197);
            ...
            marqueeLabel.ForeColor = Color.FromArgb(245, 245, 245);
            marqueeLabel.BackColor = Color.FromArgb(26, 44, 70);
            ...
            calculateBtn.BackColor = Color.FromArgb(0, 132, 235);
            ...
            logoutBtn.BackColor = Color.FromArgb(57, 74, 104);
            ...
            grossLabel.ForeColor = Color.FromArgb(110, 216, 255);
            ...
            netLabel.ForeColor = Color.FromArgb(122, 228, 255);
        ...
        private void ApplyReadonlyTextboxStyles()
        {
            ...
            foreach (var name in readonlyNames)
            {
                ...
                {
                    tb.ReadOnly = true;
                    tb.BackColor = Color.FromArgb(43, 61, 92);
                    tb.ForeColor = Color.FromArgb(232, 244, 255);
                }
            }
        }
        ...
        private void LoadUserData(TextBox nameTextBox, TextBox salaryTextBox, TextBox mealTextBox)
        {
            ...
            if (user != null)
            {
                ...
                if (taxThresholdFound.Length > 0 && taxThresholdFound[0] is TextBox taxThresholdTextBox)
                {
                    ...
                    taxThresholdTextBox.ReadOnly = true;
                    taxThresholdTextBox.BackColor = Color.FromArgb(43, 61, 92);
                }
