                          ...
                          TextBox allowanceTextBox, TextBox recognizeTextBox, TextBox otherBonusTextBox, TextBox taxThresholdTextBox)
        {
            try
            {
                ...
                var calculationDetail = new SalaryCalculationDetail
                {
                    ...
                    Overtime2xHours = overtime2xHours,
                    Overtime3xHours = overtime3xHours,
                    Overtime15xHours = overtime15xHours,
                    OtDays12 = otDays12,
                    OtDays8 = otDays8,
                    SelectedRating = selectedRating,
                    RecognizeCount = recognizeCount,
                    OtherBonus = otherBonus,
                    Meal12Amount = meal12Amount,
                    Meal8Amount = meal8Amount,
                    TravelPerDay = travelPerDay,
                    AttendancePerDay = attendancePerDay,
                    CertificateBonus = certificateBonus,
                    RankingABonusAmount = rankingAAmount,
                    RankingBBonusAmount = rankingBAmount,
                    RankingCBonusAmount = rankingCAmount
                };
