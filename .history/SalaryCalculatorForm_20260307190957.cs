    ...
    public partial class SalaryCalculatorForm : Form
    {
                          ...
                          TextBox allowanceTextBox, TextBox recognizeTextBox, TextBox otherBonusTextBox, TextBox taxThresholdTextBox)
        {
            try
            {
                ...
                decimal recognizeBonus = recognizeCount * 50000m;
                ...
                decimal totalIncentive = travelAllowance + attendanceIncentive + housingAllowance + ratingBonus + certificateBonus + recognizeBonus + otherBonus;
                ...
                if (recognizeCount > 0)
                {
                    incentiveInfo += $"\n  • Recognize ({recognizeCount} × 50k): {recognizeBonus:C0} VND";
                }
                if (otherBonus > 0)
                {
