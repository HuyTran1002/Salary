...
namespace SalaryCalculator
{
    public partial class SalaryCalculatorForm : Form
    {
        ...
        }
        {
            ...
            // Get AI-smart message with memory
            string smartMessage = GenerateSmartContextMessage(target, netValue, taxPercent, overtime3x, overtime2x, emptyKeyFields);
            
            // Add to history to avoid repetition
            UpdateSpeechHistory(smartMessage);
            
            return smartMessage;
        }

        private string GenerateSmartContextMessage(Control target, decimal netValue, decimal taxPercent, decimal overtime3x, decimal overtime2x, int emptyKeyFields)
        {
