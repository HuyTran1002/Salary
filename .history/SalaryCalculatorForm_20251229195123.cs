/*
    Recent updates (2025-12-29) - v1.0.2.0
    - Added applause.wav support: plays applause after salary results are shown.
    - Embedded Assets/audio/applause.wav into project for single-file EXE.
    - Re-added playback helper PlayApplauseEmbedded() and called it after result display.
    - Bumped version to 1.0.2.0 and added release build under Releases/1.0.2.0 (EXE not pushed to repo).
*/
using System;
using System.Linq;
    ...
    public partial class SalaryCalculatorForm : Form
    {
                                      ...
                                      TextBox attendanceTextBox, TextBox recognizeTextBox, TextBox otherBonusTextBox, TextBox taxThresholdTextBox)
        {
            try
            {
                ...
                // Play embedded applause.wav if available
                try
                {
