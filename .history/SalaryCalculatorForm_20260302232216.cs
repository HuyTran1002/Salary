...
namespace SalaryCalculator
{
    public partial class SalaryCalculatorForm : Form
    {
            ...
            try
            {
                ...
                typingTimer.Tick += (s, e) =>
                {
                    if (labelIndex < labels.Length)
                    {
                        ...
                        {
                            AnimateTypingEffect(labels[labelIndex], currentText, 5, () =>
                            {
                                // Display detail label only after result typing is fully completed
        ...
        private void AnimateTypingEffect(Label label, string fullText, int delayPerChar = 15, Action onCompleted = null)
        {
            label.Text = "";
            var typingTimer = new System.Windows.Forms.Timer();
            int charIndex = 0;
