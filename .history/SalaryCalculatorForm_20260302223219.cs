...
namespace SalaryCalculator
{
    public partial class SalaryCalculatorForm : Form
    {
            ...
            {
                Color.FromArgb(48, 48, 106),
                Color.FromArgb(60, 56, 132),
                Color.FromArgb(56, 76, 156),
                Color.FromArgb(76, 64, 164),
                Color.FromArgb(44, 72, 140)
            };
        ...
        private void InitializeComponent()
        {
            if (currentUsername == "admin")
            {
                ...
                rankingGrid.GridColor = Color.FromArgb(82, 100, 178);
                rankingGrid.BackgroundColor = Color.FromArgb(28, 30, 70);
                ...
                rankingGrid.RowsDefaultCellStyle.BackColor = Color.FromArgb(38, 42, 90);
                rankingGrid.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(46, 50, 101);
                rankingGrid.DefaultCellStyle.SelectionBackColor = Color.FromArgb(124, 76, 255);
                rankingGrid.DefaultCellStyle.SelectionForeColor = Color.White;
                rankingGrid.DefaultCellStyle.ForeColor = Color.FromArgb(238, 244, 255);
                ...
                foreach (var u in sortedBySalary)
                {
                    ...
                    if (rank == 1)
                    {
                        ...
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(56, 76, 156);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(246, 250, 255);
                    }
                    else if (rank == 2)
                    {
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.Font = new System.Drawing.Font("Arial", 11, System.Drawing.FontStyle.Bold);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(68, 62, 146);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(242, 248, 255);
                    }
                    else if (rank == 3)
                    {
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.Font = new System.Drawing.Font("Arial", 10.5f, System.Drawing.FontStyle.Bold);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(58, 56, 126);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(240, 246, 255);
                    }
                    else
                    {
                        ...
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.BackColor = Color.FromArgb(38, 42, 90);
                        rankingGrid.Rows[rowIdx].DefaultCellStyle.ForeColor = Color.FromArgb(238, 244, 255);
                    }
                    rank++;
                }
                ...
                for (int i = sorted.Count + 1; i <= minRows; i++)
                {
                    ...
                    rankingGrid.Rows[idx].DefaultCellStyle.BackColor = Color.FromArgb(44, 46, 96);
                }
                ...
                try
                {
                    ...
                    rankingGrid.RowsDefaultCellStyle.BackColor = Color.FromArgb(38, 42, 90);
                    rankingGrid.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(46, 50, 101);
                    rankingGrid.DefaultCellStyle.BackColor = Color.FromArgb(38, 42, 90);
                    rankingGrid.DefaultCellStyle.ForeColor = Color.FromArgb(238, 244, 255);
                    rankingGrid.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(68, 118, 255);
                    rankingGrid.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
                    rankingGrid.EnableHeadersVisualStyles = false;
            ...
            marqueeLabel.BackColor = Color.FromArgb(48, 48, 106);
            ...
            resultPanel.BackColor = Color.FromArgb(36, 38, 86);
        ...
        private void ApplyReadonlyTextboxStyles()
        {
            ...
            foreach (var name in readonlyNames)
            {
                ...
                {
                    tb.ReadOnly = true;
                    tb.BackColor = Color.FromArgb(52, 54, 102);
        ...
        private void LoadUserData(TextBox nameTextBox, TextBox salaryTextBox, TextBox mealTextBox)
        {
            ...
            if (user != null)
            {
                ...
                if (taxThresholdFound.Length > 0 && taxThresholdFound[0] is TextBox taxThresholdTextBox)
                {
                    ...
                    taxThresholdTextBox.ReadOnly = true;
                    taxThresholdTextBox.BackColor = Color.FromArgb(52, 54, 102);
                }
